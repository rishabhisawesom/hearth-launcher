...
1. Arrow through all four tiles — focus should update instantly with no visible stutter
2. Optional: Instruments → Time Profiler while navigating; target 60 FPS sustained
